...
//
// التطبيق المثبّت ليس لصاحبات المتاجر وحدهنّ: الزبونة قد تنصّبه لتتسوّق منه،
// فلو فتح على «تسجيل الدخول» بدا حكراً على أصحاب الحسابات وأُغلق دونها. صفحة
// المنصّة تخدم الاثنتين — فيها «تسوّقي» و«تسجيل الدخول» و«أنشئ متجرك» معاً.
//
// والمتصفّح كذلك: الزائرة من جوجل أو من رابطٍ بإنستغرام كانت تهبط على شبكة
// المنتجات بلا أن تعرف ما بازارا ولا لماذا تفتح متجرها فيها.
function Root() {
