...
export default class ErrorBoundary extends Component {
  ...
  componentDidCatch(error, info) {
    ...
    // أكثرُ الانهياراتِ شيوعاً ليس عطلاً في الكود بل نشرةٌ جديدةٌ وصلت والصفحةُ
    // ما تزال تعملُ بالحزمةِ القديمة: قطعةٌ قديمةٌ تستوردُ من قطعةٍ جديدةٍ فلا تجدُ
    // ما تطلب، فيُرسَمُ عنصرٌ غيرُ معرَّف. تحميلةٌ واحدةٌ تُصلحُه، وقد كانت المستخدمةُ
    // تضغطُها بنفسِها بعد أن ترى شاشةَ الخطأ. صارت تلقائيّةً ومرّةً واحدةً في الجلسة:
    // لو تكرّر الانهيارُ بعدَها فالسببُ غيرُ النشرِ، وتظهرُ الشاشةُ ومعها نصُّ الخطأ.
    reloadOnce();
  }
