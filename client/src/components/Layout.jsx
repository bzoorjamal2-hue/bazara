...
export default function Layout({ children }) {
  ...
  return (
    <div className="app-bg theme-pub flex min-h-screen flex-col">
      ...
      <SwipeBack />
      {!hideChrome && <Navbar />}
      {/* شريطُ التنقّل يُرسم هنا لا بآخر المستند: على الكمبيوتر يصعد صفّاً
          أفقياً تحت الشريط العلويّ، وعلى الجوّال يبقى مثبّتاً بالأسفل
          (position: fixed يخرجه من التدفّق فلا يفرق موضعُه بالشيفرة).
          كان بالأسفل فبقي هناك على الكمبيوتر أيضاً — sticky يثبّت العنصر
          حيث هو ولا يرفعه. */}
