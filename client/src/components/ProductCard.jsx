...
const PLACEHOLDER =
  ...
  encodeURIComponent(
    '<svg xmlns="http://www.w3.org/2000/svg" width="400" height="400"><rect width="100%" height="100%" fill="%23121214"/><text x="50%" y="50%" fill="%23d4af37" font-size="48" text-anchor="middle" dy=".35em">👗</text></svg>'
  );
