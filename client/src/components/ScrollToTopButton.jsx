...
export default function ScrollToTopButton() {
  ...
  return (
    <button
      ...
      className="bz-fab fixed start-5 z-40 flex h-11 w-11 items-center justify-center rounded-full transition hover:scale-110 active:scale-95 animate-fade-in"
