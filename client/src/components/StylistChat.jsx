    ...
    <>
      ...
      <button
        ...
        style={{
          ...
          background: dark ? 'linear-gradient(150deg,#E3D5BB,#BCA989)' : 'linear-gradient(150deg,#2B2A29,#141413)',
          boxShadow: dark
            ? '0 10px 24px -10px rgba(216, 199, 172,0.45), 0 2px 6px -2px rgba(0,0,0,0.3)'
