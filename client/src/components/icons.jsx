...
export function BagIcon({ className = 'h-5 w-5' }) { return svg(className, <><path {...L} d="M5.6 7.9 H18.4 L19.3 19.1 A1.7 1.7 0 0 1 17.6 20.9 H6.4 A1.7 1.7 0 0 1 4.7 19.1 Z" /><path {...L} d="M9 10.3 V7.2 A3 3 0 0 1 15 7.2 V10.3" /></>); }
...
export function ReceiptIcon({ className = 'h-5 w-5' }) { return svg(className, <><path {...L} d="M5.6 4.8 A1.6 1.6 0 0 1 7.2 3.2 H16.8 A1.6 1.6 0 0 1 18.4 4.8 V20.6 L15.9 19 L13.4 20.6 L10.9 19 L8.4 20.6 L5.6 19 Z" /><path {...L} d="M8.8 8.4 H15.2 M8.8 11.8 H15.2 M8.8 15.2 H12.6" /></>); }
export function TruckIcon({ className = 'h-5 w-5' }) { return svg(className, <><path {...L} d="M2.6 7.6 A1.6 1.6 0 0 1 4.2 6 H12.4 A1.6 1.6 0 0 1 14 7.6 V16.4 H2.6 Z" /><path {...L} d="M14 10.3 H17.2 A1.6 1.6 0 0 1 18.5 10.9 L20.9 14.1 A1.6 1.6 0 0 1 21.2 15 V16.4 H14 Z" /><circle {...L} cx="7" cy="18" r="1.85" /><circle {...L} cx="17.4" cy="18" r="1.85" /></>); }
export function CashIcon({ className = 'h-5 w-5' }) { return svg(className, <><rect {...L} x="2.6" y="6.2" width="18.8" height="11.6" rx="2.4" /><circle {...L} cx="12" cy="12" r="2.5" /><circle cx="6.1" cy="12" r="0.95" fill="currentColor" /><circle cx="17.9" cy="12" r="0.95" fill="currentColor" /></>); }
...
export function StoreIcon({ className = 'h-5 w-5' }) { return svg(className, <><path {...L} d="M4.3 9.5 L5.3 4.8 A1.1 1.1 0 0 1 6.4 3.9 H17.6 A1.1 1.1 0 0 1 18.7 4.8 L19.7 9.5 A2.9 2.9 0 0 1 14.1 9.5 A2.9 2.9 0 0 1 9.9 9.5 A2.9 2.9 0 0 1 4.3 9.5 Z" /><path {...L} d="M5.9 11.4 V18.7 A1.4 1.4 0 0 0 7.3 20.1 H16.7 A1.4 1.4 0 0 0 18.1 18.7 V11.4" /><path {...L} d="M10 20.1 V15.1 A1 1 0 0 1 11 14.1 H13 A1 1 0 0 1 14 15.1 V20.1" /></>); }
...
export function VideoIcon({ className = 'h-5 w-5' }) { return svg(className, <><rect {...L} x="2.8" y="5.8" width="13.2" height="12.4" rx="3" /><path {...L} d="M16 10.3 L19.9 7.9 A1 1 0 0 1 21.4 8.8 V15.2 A1 1 0 0 1 19.9 16.1 L16 13.7 Z" /></>); }
...
export function HomeIcon({ className = 'h-5 w-5' }) { return svg(className, <><path {...L} d="M3.4 10.9 L10.8 4.3 A1.8 1.8 0 0 1 13.2 4.3 L20.6 10.9" /><path {...L} d="M5.8 9.2 V18.6 A1.6 1.6 0 0 0 7.4 20.2 H16.6 A1.6 1.6 0 0 0 18.2 18.6 V9.2" /><path {...L} d="M9.9 20.2 V14.9 A1.5 1.5 0 0 1 11.4 13.4 H12.6 A1.5 1.5 0 0 1 14.1 14.9 V20.2" /></>); }
...
// مسنن إعدادات حقيقي: ٨ أسنان مربّعة حول محور مركزي (بديل شكل «الشمس» السابق)
export function GearIcon({ className = 'h-5 w-5' }) { return svg(className, <><path {...L} d="M19.49 10.20 L22.10 10.58 L22.10 13.42 L19.49 13.80 L18.57 16.02 L20.15 18.14 L18.14 20.15 L16.02 18.57 L13.80 19.49 L13.42 22.10 L10.58 22.10 L10.20 19.49 L7.98 18.57 L5.86 20.15 L3.85 18.14 L5.43 16.02 L4.51 13.80 L1.90 13.42 L1.90 10.58 L4.51 10.20 L5.43 7.98 L3.85 5.86 L5.86 3.85 L7.98 5.43 L10.20 4.51 L10.58 1.90 L13.42 1.90 L13.80 4.51 L16.02 5.43 L18.14 3.85 L20.15 5.86 L18.57 7.98 Z" /><circle {...L} cx="12" cy="12" r="3" /></>); }
...
export function TrashIcon({ className = 'h-5 w-5' }) { return svg(className, <><path {...L} d="M4.6 6.9 H19.4" /><path {...L} d="M9.4 6.9 V5.5 A1.3 1.3 0 0 1 10.7 4.2 H13.3 A1.3 1.3 0 0 1 14.6 5.5 V6.9" /><path {...L} d="M6.7 6.9 L7.6 19.1 A1.7 1.7 0 0 0 9.3 20.7 H14.7 A1.7 1.7 0 0 0 16.4 19.1 L17.3 6.9" /><path {...L} d="M10.3 10.4 V17 M13.7 10.4 V17" /></>); }
...
export function CrownIcon({ className = 'h-5 w-5' }) { return svg(className, <><path {...L} d="M4.2 18.3 L5.2 7.9 A0.65 0.65 0 0 1 6.3 7.5 L9.4 10.9 L11.4 5.7 A0.65 0.65 0 0 1 12.6 5.7 L14.6 10.9 L17.7 7.5 A0.65 0.65 0 0 1 18.8 7.9 L19.8 18.3 A1.5 1.5 0 0 1 18.3 19.9 H5.7 A1.5 1.5 0 0 1 4.2 18.3 Z" /><path {...L} d="M8.3 16 H15.7" /></>); }
...
export function CardIcon({ className = 'h-5 w-5' }) { return svg(className, <><rect {...L} x="2.7" y="4.9" width="18.6" height="14.2" rx="2.8" /><path {...L} d="M2.7 9.4 H21.3" /><path {...L} d="M6.2 14.8 H10.4" /></>); }
export function RulerIcon({ className = 'h-5 w-5' }) { return svg(className, <><path {...L} d="M3.7 16.7 L16.7 3.7 L20.3 7.3 L7.3 20.3 Z" /><path {...L} d="M6.9 13.4 L9 15.5 M10.2 10.2 L12.3 12.3 M13.4 6.9 L15.5 9" /></>); }
...
export function FolderIcon({ className = 'h-5 w-5' }) { return svg(className, <path {...L} d="M3.2 7.2 A1.8 1.8 0 0 1 5 5.4 H9.1 A1.8 1.8 0 0 1 10.6 6.2 L11.8 8.1 H19 A1.8 1.8 0 0 1 20.8 9.9 V17.8 A1.8 1.8 0 0 1 19 19.6 H5 A1.8 1.8 0 0 1 3.2 17.8 Z" />); }
export function NoteIcon({ className = 'h-5 w-5' }) { return svg(className, <><path {...L} d="M6.4 3.3 H13.9 L19 8.4 V19.3 A1.5 1.5 0 0 1 17.5 20.8 H6.4 A1.5 1.5 0 0 1 4.9 19.3 V4.8 A1.5 1.5 0 0 1 6.4 3.3 Z" /><path {...L} d="M13.9 3.3 V7.3 A1.1 1.1 0 0 0 15 8.4 H19" /><path {...L} d="M8.2 12.4 H15.4 M8.2 16 H12.9" /></>); }
export function TrophyIcon({ className = 'h-5 w-5' }) { return svg(className, <><path {...L} d="M7.6 3.8 H16.4 V9.3 A4.4 4.4 0 0 1 7.6 9.3 Z" /><path {...L} d="M7.6 5.6 H4.7 A0.8 0.8 0 0 0 3.9 6.4 V7.3 A3.3 3.3 0 0 0 7.2 10.6" /><path {...L} d="M16.4 5.6 H19.3 A0.8 0.8 0 0 1 20.1 6.4 V7.3 A3.3 3.3 0 0 1 16.8 10.6" /><path {...L} d="M12 13.6 V16.5" /><path {...L} d="M8.8 20.3 L9.8 16.5 H14.2 L15.2 20.3 Z" /></>); }
...
export function PartyIcon({ className = 'h-5 w-5' }) { return svg(className, <><path {...L} d="M4.1 19.9 L8.7 9.5 Q12.4 12 14.5 15.3 Z" /><path {...L} d="M13.6 8.6 C15.4 7.4 16.4 5.5 16.3 3.4" /><circle cx="19.4" cy="6.3" r="1.05" fill="currentColor" /><circle cx="20.8" cy="11.4" r="0.9" fill="currentColor" /><circle cx="14.9" cy="4.4" r="0.85" fill="currentColor" /></>); }
...
export function GridIcon({ className = 'h-5 w-5' }) { return svg(className, <><rect {...L} x="3.7" y="3.7" width="6.6" height="6.6" rx="1.9" /><rect {...L} x="13.7" y="3.7" width="6.6" height="6.6" rx="1.9" /><rect {...L} x="3.7" y="13.7" width="6.6" height="6.6" rx="1.9" /><rect {...L} x="13.7" y="13.7" width="6.6" height="6.6" rx="1.9" /></>); }
...
export function TagIcon({ className = 'h-5 w-5' }) { return svg(className, <><path {...L} d="M11.1 3.5 H5.5 A2 2 0 0 0 3.5 5.5 V11.1 A2 2 0 0 0 4.1 12.5 L11.5 19.9 A2 2 0 0 0 14.3 19.9 L19.9 14.3 A2 2 0 0 0 19.9 11.5 L12.5 4.1 A2 2 0 0 0 11.1 3.5 Z" /><circle cx="8.1" cy="8.1" r="1.35" fill="currentColor" /></>); }
...
// علامة استفهام داخل دائرة — زر التلميح «؟» بكل النماذج. رُسمت كأيقونة SVG بدل
// حرف «؟» النصّي: الحرف يختلف شكله ووزنه بين الخطوط والأجهزة ولا يتمركز داخل
// الدائرة (يبدو نازلاً عن سطر التسمية)، أما المسار فمتمركز دائماً وبأي حجم.
...
export function PrintIcon({ className = 'h-5 w-5' }) {
  return svg(className, <><path {...L} d="M7.2 9 V4.9 A1.3 1.3 0 0 1 8.5 3.6 H15.5 A1.3 1.3 0 0 1 16.8 4.9 V9" /><path {...L} d="M7.2 16.4 H5.4 A2 2 0 0 1 3.4 14.4 V11 A2 2 0 0 1 5.4 9 H18.6 A2 2 0 0 1 20.6 11 V14.4 A2 2 0 0 1 18.6 16.4 H16.8" /><path {...L} d="M8.5 13.6 H15.5 A1.3 1.3 0 0 1 16.8 14.9 V19.1 A1.3 1.3 0 0 1 15.5 20.4 H8.5 A1.3 1.3 0 0 1 7.2 19.1 V14.9 A1.3 1.3 0 0 1 8.5 13.6 Z" /><circle cx="17.6" cy="11.7" r="0.85" fill="currentColor" /></>);
}
