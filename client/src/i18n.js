...
i18n
  ...
  .init({
    ...
    detection: {
      ...
      // و`?lang=en` يسبقُ المخزَّنَ فيفتحُ بالإنجليزيّةِ من أوّلِ رسمة: مراجعُ ميتا
      // أو أيُّ قارئٍ أجنبيّ يصلُه الرابطُ فيقرأُ بلا بحثٍ عن زرِّ اللغة. والاختيارُ
      // يُخزَّنُ بعدَها كأنّه بدّلها بنفسِه، فلا يعودُ الرابطُ لازماً في كلِّ مرّة.
