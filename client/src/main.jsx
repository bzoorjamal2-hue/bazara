...
import { purgeLegacyStorage } from './utils/legacyStorage.js';
...
applyPerfTier();
// مفاتيحُ خزنٍ خلّفَتها نسخٌ سابقةٌ تُمسَحُ قبلَ أيِّ شيءٍ آخر — أهمُّها كلمةُ المرورِ
// التي كانت «تذكّرني» تحفظُها نصّاً على الجهاز.
purgeLegacyStorage();
