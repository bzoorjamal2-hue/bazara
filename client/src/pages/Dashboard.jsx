...
import {
  ...
  WhatsAppIcon, ShareIcon, SparkleIcon, PaletteIcon,
      ...
      <header className="bz-dashhero">
        ...
        <div className="bz-dashhero-in">
          <div className="flex min-w-0 items-center gap-3.5">
            ...
            {/* الجرسُ طرفُ السطرِ المقابلُ للصورة: على الجوّالِ كان معلّقاً بزاويةٍ
                فارغةٍ لا يحاذي صورةً ولا اسماً ولا زرّاً — دائرةٌ تطفو وحدَها.
                وهو الآن عضوٌ بصفِّ الهويّةِ نفسِه، فيقعُ على محورِ الصورةِ أفقيّاً
                ويصيرُ لها نظيراً بالطرفِ الآخر. وعلى الشاشةِ الواسعةِ يعودُ إلى
                زاويةِ الشريط (بالـCSS): هناك الصفُّ أفقيٌّ والأزرارُ بالطرفِ
                المقابل، فلا فراغَ يُعلَّقُ فيه. */}
