              ...
              <div className="bz-phone-body">
                ...
                <div className="bz-phone-screen">
                  ...
                  {/* لقطةُ المديرة إن رفعتها، وإلا الملفُّ المولَّد بالسكربت.
                      الأبعادُ هنا نسبةٌ لا مقاس: ‎540×1132 = 2.096 وهي نسبةُ
                      صندوقِ الصورةِ داخلَ الإطارِ بالضبط (الشاشةُ ناقصَ شريطِ
                      الحالة). كانت ‎540×1170 = 2.167، فيقصُّ ‎object-fit: cover
                      ثلاثةً بالمئةِ من أسفلِ اللقطةِ — وهي الشريطُ السفليُّ. */}
                  <img
