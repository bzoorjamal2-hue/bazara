...
export default function ReferralsManager() {
  ...
  if (error) {
    return (
      <div className="rounded-xl border border-red-400/30 bg-red-500/10 px-4 py-4 text-sm text-red-700">
        <p>{error}</p>
  ...
  return (
    <div>
      {/* السطر التعريفي هو subtitle نفسه — كان يتكرّر تحت العنوان بلا داعٍ */}
      <div className="mb-5">
