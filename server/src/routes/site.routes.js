...
import { getSiteBanners, updateSiteBanners, listNewsletter, removeNewsletter } from '../controllers/site.controller.js';
...
router.post('/newsletter/remove', requireAuth, requireAdmin, removeNewsletter);
